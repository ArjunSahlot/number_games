...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/number_games/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/number_games/archive/master.zip", tmp)
    file += "master"
